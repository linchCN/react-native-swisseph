...
export function sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geolon, geolat, altitude, pressure, temperature) {
  return Native.sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geolon, geolat, altitude, pressure, temperature);
}
