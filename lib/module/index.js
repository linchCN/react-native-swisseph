...
export function sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geopos, atpress = 0, attemp = 0) {
  return Native.sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geopos, atpress, attemp);
}
