...
function sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geolon, geolat, altitude, pressure, temperature) {
  return _NativeSwisseph.default.sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geolon, geolat, altitude, pressure, temperature);
}
