...
function sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geopos, atpress = 0, attemp = 0) {
  return _NativeSwisseph.default.sweRiseTrans(tjdUt, ipl, starname, epheflag, rsmi, geopos, atpress, attemp);
}
